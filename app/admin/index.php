    ...
    <div class="col-md-3">
      <div class="card bg-primary text-white">
        <div class="card-body text-center">
          ...
          <h6 class="">Jumlah Gejala Kerusakan Komputer</h6>
        </div>
      </div>
    </div>    
    ...
    <div class="col-md-3">
      <div class="card bg-info text-white">
        <div class="card-body text-center">
          ...
          <h6 class="">Jumlah Alternatif / Kerusakan Komputer</h6>
        </div>
      </div>
    </div>  
    ...
    <div class="col-md-3">
      <div class="card bg-warning">
        <div class="card-body text-center">
          ...
          <h6 class="">Jumlah Riwayat Diagnosa Pengguna </h6>
        </div>
      </div>
    </div>   
    ...
    <div class="col-md-3">
      <div class="card bg-danger text-white">
        <div class="card-body text-center">
          ...
          <h6 class="">Jumlah User Admin / Pakar Sistem Pakar</h6>
        </div>
      </div>
    </div>   
