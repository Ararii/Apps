...
<header style="background-color: #5A7963;" id="header" class="ex-header" style="padding-top: 8rem;padding-bottom: 2rem;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>Hasil Diagnosa</h1>
                <p class="text-white">Hasil diagnosa kerusakan komputer dengan metode forward chaining.</p>
                <div class="form">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="text-container">
                                            ...
                                            while($d = mysqli_fetch_array($data)){
                                                ...
                                                <table class="table table-bordered text-left">
                                                    ...
                                                    if($hasil != "0"){
                                                        ...
                                                        <tr>
                                                            <th width="30%">HASIL <br/> <small>Forward Chaining</small></th>
                                                            <td><b><i>Kerusakan tidak ditemukan. mungkin komputer anda baik-baik saja.</i></b></td>
                                                        </tr>                     
                                                        <tr>
                                                            <th width="30%">PENYEBAB KERUSAKAN</th>
                                                            <td>-</td>
                                    ...
                                    <center>
                                        <a style="text-decoration:none" class="btn btn-primary mt-5 w-50" href="diagnosa.php">DIAGNOSA LAGI</a>
                                    </center>
